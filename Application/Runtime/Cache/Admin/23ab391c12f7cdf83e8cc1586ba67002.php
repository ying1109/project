...
<head>
    ...
    <link type="text/css" href="/Public/Admin/layer/layer.css" rel="stylesheet" />
            ...
            <form action="" method="POST" class="form-horizontal">
                            ...
                            <div class="file-list">
                                <div class="post_list mt">
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="flie-box col-sm-3">
                                        ...
                                        <!--<input name="post_banner[]" style="display: none;" value="{json_encode($v['pic']); }">-->
                                        <!--<input name='link_url[]' value="<?php echo ($v['link_url']); ?>" placeholder='跳转地址'/>-->
                                        <!--<input name='link_info[]' value="<?php echo ($v['link_info']); ?>" placeholder='其他信息'/>-->
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <!-- <a href="<?php echo U('banner_list');?>" type="button" class="btn btn-default">返回</a> -->
                    </div>
                </div>
            </form>
        </div>
        ...
        $(function(){
            ...
            $(function() {
                ...
                uploader = WebUploader.create({
                    ...
                    // server: "<?php echo U('baseToolBannerUpload');?>",
                    compress:false,
