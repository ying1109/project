    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="form-group">
                <a href="<?php echo U('moduleAddEdit');?>" class="btn btn-primary">添加编辑</a>
            </div>
            <table class="table table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tbody>
                        <tr>
                            <td><?php echo ($v["id"]); ?></td>
                            <td><?php echo (getNameById($v["pid"])); ?></td>
                            <td><?php echo ($v["name"]); ?></td>
                            <td>
                                <a class="btn btn-success btn-xs" href="<?php echo U('moduleAddEdit', array('id'=>$v['id']));?>">编辑</a>
                                <a class="btn btn-danger btn-xs" href="#" name="<?php echo ($v['id']); ?>">删除</a>
                            </td>
                        </tr>
