...
<script type="text/javascript" src="/Public/Admin/login/js/jquery-ui.min.js"></script>
<script type="text/javascript" src='/Public/Admin/login/js/stopExecutionOnTimeout.js?t=1'></script>
...
<script>
    /*$("#login").click(function(){
        ...
        var uuu = "<?php echo U('Login/ajax_login');?>";
        alert(uuu);
        $.ajax({
